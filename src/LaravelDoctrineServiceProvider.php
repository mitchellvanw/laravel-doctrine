...
class LaravelDoctrineServiceProvider extends ServiceProvider
{
	...
	{
		$this->app->singleton('Mitch\LaravelDoctrine\Configuration\DriverMapper', function() {
            $mapper = new DriverMapper;
            $mapper->registerMapper(new SqlConfigurationMapper);
            $mapper->registerMapper(new SqliteConfigurationMapper);
		});
	}
